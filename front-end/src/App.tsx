...
import { type MainSection } from './features/dashboard/types'
...
function App() {
  ...
  return (
    <div className='app'>
        ...
        <nav className='navbar'>
          <div className='nav-container'>
            ...
            <div className='nav-right'>
              ...
              <button type='button' className='nav-link nav-link-button' onClick={() => setShowBmiModal(true)}>
                Tính Chỉ Số BMI
              </button>
              <a
                href='#muscle-wiki'
      ...
      {!isLoggedIn && currentPage === 'muscle-wiki' && <MuscleWikiPage onBack={() => setCurrentPage('home')} />}
